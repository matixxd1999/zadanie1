 ...
 */
final class Version20220419184221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin_warehouses (admin_id INT NOT NULL, warehouses_id INT NOT NULL, INDEX IDX_67D76432642B8210 (admin_id), INDEX IDX_67D76432864AC21A (warehouses_id), PRIMARY KEY(admin_id, warehouses_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE admin_warehouses ADD CONSTRAINT FK_67D76432642B8210 FOREIGN KEY (admin_id) REFERENCES admin (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE admin_warehouses ADD CONSTRAINT FK_67D76432864AC21A FOREIGN KEY (warehouses_id) REFERENCES ware_houses (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE materials_in_warehouse ADD amount INT DEFAULT NULL, ADD vat DOUBLE PRECISION DEFAULT NULL, ADD unit_price DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materials_in_warehouse DROP amount, DROP vat, DROP unit_price');
    }
}
