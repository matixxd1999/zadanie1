 ...
 */
final class Version20220419184452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin_ware_houses (admin_id INT NOT NULL, ware_houses_id INT NOT NULL, INDEX IDX_A8775861642B8210 (admin_id), INDEX IDX_A8775861405F6168 (ware_houses_id), PRIMARY KEY(admin_id, ware_houses_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE admin_ware_houses ADD CONSTRAINT FK_A8775861642B8210 FOREIGN KEY (admin_id) REFERENCES admin (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE admin_ware_houses ADD CONSTRAINT FK_A8775861405F6168 FOREIGN KEY (ware_houses_id) REFERENCES ware_houses (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE admin_ware_houses');
    }
}
